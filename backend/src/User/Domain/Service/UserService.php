...
class UserService
{
     ...
     */
    public function createUser(string $email, string $password, string $username): UserId
    {
        ...
        $user = new User($this->repository->nextId(), new Email($email), new Password($password), $username);
     ...
     */
    public function updateUserData(UserId $userId, string $username, string $phone, string $firstName, string $lastName, Email $email, string $avatarUrl): void
    {
        //TODO: обернуть в транзакцию
